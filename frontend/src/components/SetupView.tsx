          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.85rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ color: '#10b981', fontWeight: 700 }}>✓ Verified ({capabilities.energy.idle_watts} W idle)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span>CPU Frequency Caps</span>
                <span style={{ color: '#10b981', fontWeight: 700 }}>✓ Verified (16 policies, boost=0 pair)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ color: capabilities.machine.ac_power ? '#10b981' : '#f59e0b', fontWeight: 600 }}>
