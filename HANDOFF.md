...
- **In flight:** Commit/push the profile-point integration. CLI execution remains intentionally deferred until A's helper contract can apply/read back/restore safely.
